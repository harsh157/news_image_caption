...
def parse_opt():
    ...
    parser.add_argument('--input_image_h5', type=str, default='./data/data_news_image.h5', # data_europeana_image.h5
    ...
    parser.add_argument('--start_from', type=str, default='./save/show_attend_tell',
