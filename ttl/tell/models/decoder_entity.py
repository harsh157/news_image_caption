...
@Decoder.register('dynamic_conv_decoder_entity')
class DynamicConvDecoderEntity(Decoder):
    def __init__(self, vocab, embedder: TextFieldEmbedder, max_target_positions, dropout,
        ...
        self.layers.extend([
            DynamicConvEntityDecoderLayer(embed_dim, decoder_conv_dim, decoder_glu,
                                    decoder_conv_type, weight_softmax, decoder_attention_heads,
...
@DecoderLayer.register('dynamic_conv_entity')
class DynamicConvEntityDecoderLayer(DecoderLayer):
