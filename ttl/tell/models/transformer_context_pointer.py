...
@Model.register("transformer_context_pointer")
class TransformerContextPointerModel(LoadStateDictWithPrefix, Model):
    def __init__(self,
                 vocab: Vocabulary,
                 decoder: Decoder,
                 criterion: Criterion,
    ...
    def forward(self,  # type: ignore
        ...
        decoder_out = self.decoder(caption, contexts, article_ids)
        ...
        if not self.training and self.evaluate_mode:
            ...
            #else:
            _, gen_ids = self._generate(caption_ids, contexts, article_ids)
            # We ignore <s> and <pad>
